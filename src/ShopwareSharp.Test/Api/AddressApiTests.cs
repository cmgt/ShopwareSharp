...
namespace ShopwareSharp.Test.Api
{
    ...
    public sealed class AddressApiTests : ApiTestsBase
    {
        ...
        public async Task CreateCustomerAddressAsyncTest()
        {
            ...
            var response = await _instance.CreateCustomerAddressAsync(contentType, accept, customerAddress);
        ...
        public async Task DefaultBillingAddressAsyncTest()
        {
            ...
            string contentType = default;
            string accept = default;
            await _instance.DefaultBillingAddressAsync(addressId, contentType, accept);
        }
        ...
        public async Task DefaultShippingAddressAsyncTest()
        {
            ...
            string contentType = default;
            string accept = default;
            await _instance.DefaultShippingAddressAsync(addressId, contentType, accept);
        }
        ...
        public async Task DeleteCustomerAddressAsyncTest()
        {
            ...
            string contentType = default;
            string accept = default;
            await _instance.DeleteCustomerAddressAsync(addressId, contentType, accept);
        }
        ...
        public async Task UpdateCustomerAddressAsyncTest()
        {
            ...
            string accept = default;
            CustomerAddress? customerAddress = default;
            var response = await _instance.UpdateCustomerAddressAsync(addressId, contentType, accept, customerAddress);
            Assert.IsType<CustomerAddress>(response);
        }
    }
}
