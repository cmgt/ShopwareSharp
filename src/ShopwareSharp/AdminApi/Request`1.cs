...
{
    public class Request<T> : IEquatable<Request<T>>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append($"class Request<{typeof(T)}> {{\n");
        ...
        {
            return this.Equals(input as Request<T>);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Request<T>? input)
        {
            if (input == null)
            {
                return false;
