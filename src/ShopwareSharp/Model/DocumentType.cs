...
namespace ShopwareSharp.Model
{
    ...
    public partial class DocumentType : IEquatable<DocumentType>, IValidatableObject
    {
        ...
        public DocumentType(string id = default(string), string name = default(string), string technicalName = default(string), Object customFields = default(Object), Object translated = default(Object))
        {
