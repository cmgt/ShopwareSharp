...
namespace ShopwareSharp.Model
{
    ...
    public partial class NumberRangeType : IEquatable<NumberRangeType>, IValidatableObject
    {
        ...
        public NumberRangeType(DateTime createdAt, string? id = default, DateTime? updatedAt = default, Object? translated = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for NumberRangeType and cannot be null.");
