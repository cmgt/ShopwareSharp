...
namespace ShopwareSharp.Model
{
    ...
    public partial class Tag : IEquatable<Tag>, IValidatableObject
    {
        ...
        public Tag(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for Tag and cannot be null.");
