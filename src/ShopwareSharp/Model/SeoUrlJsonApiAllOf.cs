...
namespace ShopwareSharp.Model
{
    ...
    /// SeoUrlJsonApiAllOf
    /// </summary>
    public partial class SeoUrlJsonApiAllOf : IEquatable<SeoUrlJsonApiAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeoUrlJsonApiAllOf" /> class.
        /// </summary>
        ...
        public SeoUrlJsonApiAllOf(string languageId, string foreignKey, string routeName, string pathInfo, string seoPathInfo, DateTime createdAt, string? id = default, string? salesChannelId = default, bool? isCanonical = default, bool? isModified = default, bool? isDeleted = default, string? url = default, Object? customFields = default, DateTime? updatedAt = default)
        {
            if (languageId == null)
                throw new ArgumentNullException("languageId is a required property for SeoUrlJsonApiAllOf and cannot be null.");

            if (foreignKey == null)
                throw new ArgumentNullException("foreignKey is a required property for SeoUrlJsonApiAllOf and cannot be null.");

            if (routeName == null)
                throw new ArgumentNullException("routeName is a required property for SeoUrlJsonApiAllOf and cannot be null.");

            if (pathInfo == null)
                throw new ArgumentNullException("pathInfo is a required property for SeoUrlJsonApiAllOf and cannot be null.");

            if (seoPathInfo == null)
                throw new ArgumentNullException("seoPathInfo is a required property for SeoUrlJsonApiAllOf and cannot be null.");

            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for SeoUrlJsonApiAllOf and cannot be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeoUrlJsonApiAllOf {\n");
        ...
        {
            return this.Equals(input as SeoUrlJsonApiAllOf);
        }

        /// <summary>
        /// Returns true if SeoUrlJsonApiAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SeoUrlJsonApiAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeoUrlJsonApiAllOf? input)
        {
            if (input == null)
            {
                return false;
