...
namespace ShopwareSharp.Model
{
    ...
    public partial class ProductSorting : IEquatable<ProductSorting>, IValidatableObject
    {
        ...
        public ProductSorting(string key, long priority, string label, DateTime createdAt, string? id = default, DateTime? updatedAt = default, Object? translated = default)
        {
            if (key == null)
                throw new ArgumentNullException("key is a required property for ProductSorting and cannot be null.");

            if (priority == null)
                throw new ArgumentNullException("priority is a required property for ProductSorting and cannot be null.");

            if (label == null)
                throw new ArgumentNullException("label is a required property for ProductSorting and cannot be null.");

            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for ProductSorting and cannot be null.");
