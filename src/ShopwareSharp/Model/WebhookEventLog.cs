...
namespace ShopwareSharp.Model
{
    ...
    public partial class WebhookEventLog : IEquatable<WebhookEventLog>, IValidatableObject
    {
        ...
        public WebhookEventLog(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for WebhookEventLog and cannot be null.");
