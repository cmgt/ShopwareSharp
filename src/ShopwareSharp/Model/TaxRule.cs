...
namespace ShopwareSharp.Model
{
    ...
    public partial class TaxRule : IEquatable<TaxRule>, IValidatableObject
    {
        ...
        public TaxRule(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for TaxRule and cannot be null.");
