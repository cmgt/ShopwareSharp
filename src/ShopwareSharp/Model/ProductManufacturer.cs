...
namespace ShopwareSharp.Model
{
    ...
    public partial class ProductManufacturer : IEquatable<ProductManufacturer>, IValidatableObject
    {
        ...
        public ProductManufacturer(string name, DateTime createdAt, string? id = default, string? versionId = default, string? mediaId = default, string? link = default, string? description = default, Object? customFields = default, DateTime? updatedAt = default, Object? translated = default, Media? media = default)
        {
            if (name == null)
                throw new ArgumentNullException("name is a required property for ProductManufacturer and cannot be null.");

            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for ProductManufacturer and cannot be null.");
