...
namespace ShopwareSharp.Model
{
    ...
    public partial class MailTemplateType : IEquatable<MailTemplateType>, IValidatableObject
    {
        ...
        public MailTemplateType(string name, string technicalName, DateTime createdAt, string? id = default, Object? customFields = default, DateTime? updatedAt = default, Object? translated = default)
        {
            if (name == null)
            ...
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for MailTemplateType and cannot be null.");
