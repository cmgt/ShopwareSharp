...
namespace ShopwareSharp.Model
{
    ...
    public partial class Locale : IEquatable<Locale>, IValidatableObject
    {
        ...
        public Locale(string id = default(string), string code = default(string), string name = default(string), string territory = default(string), Object customFields = default(Object), Object translated = default(Object))
        {
            ...
            this._Name = name;
            // to ensure "territory" is required (not null)
            if (territory == null)
            {
        ...
        /// </summary>
        [DataMember(Name = "territory", IsRequired = true, EmitDefaultValue = false)]
        ...
        private bool _flagTerritory;

        /// <summary>
        /// Returns false as Territory should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeTerritory()
        {
            return _flagTerritory;
        }
        /// <summary>
