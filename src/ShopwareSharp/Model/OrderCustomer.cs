...
namespace ShopwareSharp.Model
{
    ...
    public partial class OrderCustomer : IEquatable<OrderCustomer>, IValidatableObject
    {
        ...
        public OrderCustomer(string id = default(string), string versionId = default(string), string email = default(string), string salutationId = default(string), string firstName = default(string), string lastName = default(string), string company = default(string), string title = default(string), List<string> vatIds = default(List<string>), string customerNumber = default(string), Object customFields = default(Object), Salutation salutation = default(Salutation))
        {
