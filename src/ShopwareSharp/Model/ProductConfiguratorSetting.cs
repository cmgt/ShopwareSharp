...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductConfiguratorSetting")]
    public partial class ProductConfiguratorSetting : IEquatable<ProductConfiguratorSetting>, IValidatableObject
    {
        ...
        protected ProductConfiguratorSetting() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductConfiguratorSetting" /> class.
        /// </summary>
        ...
        public ProductConfiguratorSetting(string id = default(string), string versionId = default(string), string productId = default(string), string productVersionId = default(string), string mediaId = default(string), string optionId = default(string), long position = default(long), Object customFields = default(Object), Media media = default(Media), PropertyGroupOption option = default(PropertyGroupOption))
        {
        ...
        /// </summary>
        [DataMember(Name = "optionId", IsRequired = true, EmitDefaultValue = false)]
        ...
        private bool _flagOptionId;

        /// <summary>
        /// Returns false as OptionId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeOptionId()
        {
            return _flagOptionId;
        }
        /// <summary>
        ...
        public PropertyGroupOption Option
        {
            get{ return _Option;}
            set
            {
        ...
        private PropertyGroupOption _Option;
        private bool _flagOption;
