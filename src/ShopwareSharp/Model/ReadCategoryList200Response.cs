...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "readCategoryList_200_response")]
    public partial class ReadCategoryList200Response : IEquatable<ReadCategoryList200Response>, IValidatableObject
    {
        ...
        public ReadCategoryList200Response(string apiAlias = default(string), string entity = default(string), int total = default(int), List<Object> aggregations = default(List<Object>), int page = default(int), int limit = default(int), List<Category> elements = default(List<Category>))
        {
        ...
        private List<Category> _Elements;
