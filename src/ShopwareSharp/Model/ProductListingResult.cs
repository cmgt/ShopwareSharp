...
namespace ShopwareSharp.Model
{
    ...
    public partial class ProductListingResult : IEquatable<ProductListingResult>, IValidatableObject
    {
        ...
        /// <param name="productListingResultAllOf"></param>
        ...
        public ProductListingResult(EntitySearchResult entitySearchResult, ProductListingResultAllOf productListingResultAllOf, string? apiAlias = default, string? entity = default, int? total = default, List<Object>? aggregations = default, int? page = default, int? limit = default)
        {
            EntitySearchResult = entitySearchResult;
            ProductListingResultAllOf = productListingResultAllOf;
            ApiAlias = apiAlias;
            Entity = entity;
            Total = total;
        ...
        /// <summary>
        /// Gets or Sets ProductListingResultAllOf
        /// </summary>
        public ProductListingResultAllOf ProductListingResultAllOf { get; set; }
    ...
    /// <summary>
    /// A Json converter for type ProductListingResult
    /// </summary>
    public class ProductListingResultJsonConverter : JsonConverter<ProductListingResult>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ProductListingResult).IsAssignableFrom(typeToConvert);
        ...
        public override ProductListingResult Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader productListingResultAllOfReader = reader;
            bool productListingResultAllOfDeserialized = Client.ClientUtils.TryDeserialize<ProductListingResultAllOf>(ref productListingResultAllOfReader, options, out ProductListingResultAllOf? productListingResultAllOf);
            ...
            return new ProductListingResult(entitySearchResult, productListingResultAllOf, apiAlias, entity, total, aggregations, page, limit);
        }
        ...
        /// <param name="productListingResult"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProductListingResult productListingResult, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
