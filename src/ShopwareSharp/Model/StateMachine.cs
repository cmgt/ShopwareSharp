...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    public partial class StateMachine : IEquatable<StateMachine>, IValidatableObject
    {
        /// <summary>
        ...
        public StateMachine(DateTime createdAt, string? id = default, DateTime? updatedAt = default, Object? translated = default, StateMachineState? states = default, StateMachineTransition? transitions = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for StateMachine and cannot be null.");
        ...
        {
            return this.Equals(input as StateMachine);
        }

        /// <summary>
        /// Returns true if StateMachine instances are equal
        /// </summary>
        /// <param name="input">Instance of StateMachine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateMachine? input)
        {
            if (input == null)
            {
                return false;
