...
namespace ShopwareSharp.Model
{
    ...
    public partial class Salutation : IEquatable<Salutation>, IValidatableObject
    {
        ...
        public Salutation(string salutationKey, string displayName, string letterName, DateTime createdAt, string? id = default, Object? customFields = default, DateTime? updatedAt = default, Object? translated = default)
        {
            ...
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for Salutation and cannot be null.");
