...
namespace ShopwareSharp.Model
{
    ...
    public partial class CartAllOf : IEquatable<CartAllOf>, IValidatableObject
    {
        ...
        public CartAllOf(string name = default(string), string token = default(string), CartAllOfPrice price = default(CartAllOfPrice), List<LineItem> lineItems = default(List<LineItem>), List<CartAllOfErrors> errors = default(List<CartAllOfErrors>), List<CartAllOfTransactions> transactions = default(List<CartAllOfTransactions>), bool modified = default(bool), string customerComment = default(string), string affiliateCode = default(string), string campaignCode = default(string))
        {
            this.Name = name;
            this.Token = token;
            this.Price = price;
