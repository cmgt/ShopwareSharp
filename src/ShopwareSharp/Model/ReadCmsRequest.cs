...
namespace ShopwareSharp.Model
{
    ...
    /// ReadCmsRequest
    /// </summary>
    public partial class ReadCmsRequest : IEquatable<ReadCmsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadCmsRequest" /> class.
        /// </summary>
        /// <param name="productListingCriteria"></param>
        /// <param name="readCmsRequestAllOf"></param>
        ...
        /// <summary>
        /// Gets or Sets ReadCmsRequestAllOf
        /// </summary>
        public ReadCmsRequestAllOf ReadCmsRequestAllOf { get; set; }
        ...
        {
            return this.Equals(input as ReadCmsRequest);
        }

        /// <summary>
        /// Returns true if ReadCmsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadCmsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadCmsRequest? input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type ReadCmsRequest
    /// </summary>
    public class ReadCmsRequestJsonConverter : JsonConverter<ReadCmsRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadCmsRequest).IsAssignableFrom(typeToConvert);
        ...
        public override ReadCmsRequest Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader readCmsRequestAllOfReader = reader;
            bool readCmsRequestAllOfDeserialized = Client.ClientUtils.TryDeserialize<ReadCmsRequestAllOf>(ref readCmsRequestAllOfReader, options, out ReadCmsRequestAllOf? readCmsRequestAllOf);
            ...
            return new ReadCmsRequest(productListingCriteria, readCmsRequestAllOf, page, limit, filter, sort, postFilter, associations, aggregations, grouping, order, manufacturer, rating, properties, propertyWhitelist, reduceAggregations, p, minPrice, maxPrice, shippingFree, manufacturerFilter, priceFilter, ratingFilter, shippingFreeFilter, propertyFilter);
        }
        ...
        public override void Write(Utf8JsonWriter writer, ReadCmsRequest readCmsRequest, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
