...
namespace ShopwareSharp.Model
{
    ...
    public partial class App : IEquatable<App>, IValidatableObject
    {
        ...
        public App(DateTime createdAt, string? id = default, DateTime? updatedAt = default, Object? translated = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for App and cannot be null.");
