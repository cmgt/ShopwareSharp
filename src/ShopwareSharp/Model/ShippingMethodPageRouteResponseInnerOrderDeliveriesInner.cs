...
namespace ShopwareSharp.Model
{
    ...
    public partial class ShippingMethodPageRouteResponseInnerOrderDeliveriesInner : IEquatable<ShippingMethodPageRouteResponseInnerOrderDeliveriesInner>, IValidatableObject
    {
        ...
        public ShippingMethodPageRouteResponseInnerOrderDeliveriesInner(string? orderId = default, string? shippingOrderAddressId = default, string? shippingMethodId = default, DateTime? shippingDateEarliest = default, DateTime? shippingDateLatest = default, string? stateId = default)
        {
            OrderId = orderId;
