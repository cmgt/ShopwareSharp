...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "readSalutation_200_response")]
    public partial class ReadSalutation200Response : IEquatable<ReadSalutation200Response>, IValidatableObject
    {
        ...
        public ReadSalutation200Response(string apiAlias = default(string), string entity = default(string), int total = default(int), List<Object> aggregations = default(List<Object>), int page = default(int), int limit = default(int), List<Salutation> elements = default(List<Salutation>))
        {
        ...
        public List<Salutation> Elements { get; set; }
