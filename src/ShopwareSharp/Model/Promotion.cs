...
namespace ShopwareSharp.Model
{
    ...
    public partial class Promotion : IEquatable<Promotion>, IValidatableObject
    {
        ...
        public Promotion(DateTime createdAt, string? id = default, Object? customFields = default, DateTime? updatedAt = default, Object? translated = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for Promotion and cannot be null.");
