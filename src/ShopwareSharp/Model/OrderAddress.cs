...
namespace ShopwareSharp.Model
{
    ...
    public partial class OrderAddress : IEquatable<OrderAddress>, IValidatableObject
    {
        ...
        public OrderAddress(string id = default(string), string versionId = default(string), string countryId = default(string), string countryStateId = default(string), string firstName = default(string), string lastName = default(string), string street = default(string), string zipcode = default(string), string city = default(string), string company = default(string), string department = default(string), string title = default(string), string vatId = default(string), string phoneNumber = default(string), string additionalAddressLine1 = default(string), string additionalAddressLine2 = default(string), Object customFields = default(Object), Country country = default(Country), CountryState countryState = default(CountryState), Salutation salutation = default(Salutation))
        {
        ...
        private bool _flagVatId;

        /// <summary>
        /// Returns false as VatId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeVatId()
        {
            return _flagVatId;
        }
        /// <summary>
