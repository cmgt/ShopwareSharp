...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    public partial class PaymentMethodJsonApiAllOf : IEquatable<PaymentMethodJsonApiAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodJsonApiAllOf" /> class.
        /// </summary>
        ...
        public PaymentMethodJsonApiAllOf(string name, DateTime createdAt, string? id = default, string? distinguishableName = default, string? description = default, long? position = default, bool? active = default, bool? afterOrderEnabled = default, Object? customFields = default, string? mediaId = default, DateTime? updatedAt = default, Object? translated = default, Object? relationships = default)
        {
            if (name == null)
                throw new ArgumentNullException("name is a required property for PaymentMethodJsonApiAllOf and cannot be null.");

            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for PaymentMethodJsonApiAllOf and cannot be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentMethodJsonApiAllOf {\n");
        ...
        {
            return this.Equals(input as PaymentMethodJsonApiAllOf);
        }

        /// <summary>
        /// Returns true if PaymentMethodJsonApiAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentMethodJsonApiAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodJsonApiAllOf? input)
        {
            if (input == null)
            {
                return false;
