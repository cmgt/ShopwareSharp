...
namespace ShopwareSharp.Model
{
    ...
    public partial class Integration : IEquatable<Integration>, IValidatableObject
    {
        ...
        public Integration(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for Integration and cannot be null.");
