...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "readCurrency_200_response")]
    public partial class ReadCurrency200Response : IEquatable<ReadCurrency200Response>, IValidatableObject
    {
        ...
        public ReadCurrency200Response(string apiAlias = default(string), string entity = default(string), int total = default(int), List<Object> aggregations = default(List<Object>), int page = default(int), int limit = default(int), List<Currency> elements = default(List<Currency>))
        {
        ...
        private List<Currency> _Elements;
