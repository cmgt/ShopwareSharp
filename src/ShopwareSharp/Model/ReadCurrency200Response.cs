...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    public partial class ReadCurrency200Response : IEquatable<ReadCurrency200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadCurrency200Response" /> class.
        /// </summary>
        /// <param name="entitySearchResult"></param>
        /// <param name="readCurrency200ResponseAllOf"></param>
        ...
        public ReadCurrency200Response(EntitySearchResult entitySearchResult, ReadCurrency200ResponseAllOf readCurrency200ResponseAllOf, string? apiAlias = default, string? entity = default, int? total = default, List<Object>? aggregations = default, int? page = default, int? limit = default)
        {
            EntitySearchResult = entitySearchResult;
            ReadCurrency200ResponseAllOf = readCurrency200ResponseAllOf;
            ApiAlias = apiAlias;
            Entity = entity;
            Total = total;
        ...
        /// <summary>
        /// Gets or Sets ReadCurrency200ResponseAllOf
        /// </summary>
        public ReadCurrency200ResponseAllOf ReadCurrency200ResponseAllOf { get; set; }
        ...
        {
            return this.Equals(input as ReadCurrency200Response);
        }

        /// <summary>
        /// Returns true if ReadCurrency200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadCurrency200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadCurrency200Response? input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type ReadCurrency200Response
    /// </summary>
    public class ReadCurrency200ResponseJsonConverter : JsonConverter<ReadCurrency200Response>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadCurrency200Response).IsAssignableFrom(typeToConvert);
        ...
        public override ReadCurrency200Response Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader readCurrency200ResponseAllOfReader = reader;
            bool readCurrency200ResponseAllOfDeserialized = Client.ClientUtils.TryDeserialize<ReadCurrency200ResponseAllOf>(ref readCurrency200ResponseAllOfReader, options, out ReadCurrency200ResponseAllOf? readCurrency200ResponseAllOf);
            ...
            return new ReadCurrency200Response(entitySearchResult, readCurrency200ResponseAllOf, apiAlias, entity, total, aggregations, page, limit);
        }
        ...
        /// <param name="readCurrency200Response"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReadCurrency200Response readCurrency200Response, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
