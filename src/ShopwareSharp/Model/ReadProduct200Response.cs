...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "readProduct_200_response")]
    public partial class ReadProduct200Response : IEquatable<ReadProduct200Response>, IValidatableObject
    {
        ...
        public ReadProduct200Response(string apiAlias = default(string), string entity = default(string), int total = default(int), List<Object> aggregations = default(List<Object>), int page = default(int), int limit = default(int), List<Product> elements = default(List<Product>))
        {
