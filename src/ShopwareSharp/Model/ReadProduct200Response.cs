...
{
    /// <summary>
    /// ReadProduct200Response
    /// </summary>
    public partial class ReadProduct200Response : IEquatable<ReadProduct200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadProduct200Response" /> class.
        /// </summary>
        /// <param name="entitySearchResult"></param>
        /// <param name="readProduct200ResponseAllOf"></param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadProduct200Response {\n");
        ...
        {
            return this.Equals(input as ReadProduct200Response);
        }

        /// <summary>
        /// Returns true if ReadProduct200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadProduct200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadProduct200Response? input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type ReadProduct200Response
    /// </summary>
    public class ReadProduct200ResponseJsonConverter : JsonConverter<ReadProduct200Response>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadProduct200Response).IsAssignableFrom(typeToConvert);
        ...
        public override ReadProduct200Response Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader readProduct200ResponseAllOfReader = reader;
            bool readProduct200ResponseAllOfDeserialized = Client.ClientUtils.TryDeserialize<ReadProduct200ResponseAllOf>(ref readProduct200ResponseAllOfReader, options, out ReadProduct200ResponseAllOf? readProduct200ResponseAllOf);
            ...
            return new ReadProduct200Response(entitySearchResult, readProduct200ResponseAllOf, apiAlias, entity, total, aggregations, page, limit);
        }
        ...
        /// <param name="readProduct200Response"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReadProduct200Response readProduct200Response, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
