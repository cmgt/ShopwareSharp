...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "readSeoUrl_200_response")]
    public partial class ReadSeoUrl200Response : IEquatable<ReadSeoUrl200Response>, IValidatableObject
    {
        ...
        public ReadSeoUrl200Response(string apiAlias = default(string), string entity = default(string), int total = default(int), List<Object> aggregations = default(List<Object>), int page = default(int), int limit = default(int), List<SeoUrl> elements = default(List<SeoUrl>))
        {
