...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    public partial class ReadSeoUrl200Response : IEquatable<ReadSeoUrl200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadSeoUrl200Response" /> class.
        /// </summary>
        /// <param name="entitySearchResult"></param>
        /// <param name="readSeoUrl200ResponseAllOf"></param>
        ...
        public ReadSeoUrl200Response(EntitySearchResult entitySearchResult, ReadSeoUrl200ResponseAllOf readSeoUrl200ResponseAllOf, string? apiAlias = default, string? entity = default, int? total = default, List<Object>? aggregations = default, int? page = default, int? limit = default)
        {
            EntitySearchResult = entitySearchResult;
            ReadSeoUrl200ResponseAllOf = readSeoUrl200ResponseAllOf;
            ApiAlias = apiAlias;
            Entity = entity;
            Total = total;
        ...
        /// <summary>
        /// Gets or Sets ReadSeoUrl200ResponseAllOf
        /// </summary>
        public ReadSeoUrl200ResponseAllOf ReadSeoUrl200ResponseAllOf { get; set; }
        ...
        {
            return this.Equals(input as ReadSeoUrl200Response);
        }

        /// <summary>
        /// Returns true if ReadSeoUrl200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadSeoUrl200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadSeoUrl200Response? input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type ReadSeoUrl200Response
    /// </summary>
    public class ReadSeoUrl200ResponseJsonConverter : JsonConverter<ReadSeoUrl200Response>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadSeoUrl200Response).IsAssignableFrom(typeToConvert);
        ...
        public override ReadSeoUrl200Response Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader readSeoUrl200ResponseAllOfReader = reader;
            bool readSeoUrl200ResponseAllOfDeserialized = Client.ClientUtils.TryDeserialize<ReadSeoUrl200ResponseAllOf>(ref readSeoUrl200ResponseAllOfReader, options, out ReadSeoUrl200ResponseAllOf? readSeoUrl200ResponseAllOf);
            ...
            return new ReadSeoUrl200Response(entitySearchResult, readSeoUrl200ResponseAllOf, apiAlias, entity, total, aggregations, page, limit);
        }
        ...
        /// <param name="readSeoUrl200Response"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReadSeoUrl200Response readSeoUrl200Response, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
