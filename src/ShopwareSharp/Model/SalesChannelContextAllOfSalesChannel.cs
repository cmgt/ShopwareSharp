...
namespace ShopwareSharp.Model
{
    ...
    public partial class SalesChannelContextAllOfSalesChannel : IEquatable<SalesChannelContextAllOfSalesChannel>, IValidatableObject
    {
        ...
        public string AnalyticsId
        {
            ...
            {
                _AnalyticsId = value;
                _flagAnalyticsId = true;
            }
        }
        private string _AnalyticsId;
        private bool _flagAnalyticsId;

        /// <summary>
        /// Returns false as AnalyticsId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAnalyticsId()
        {
            return _flagAnalyticsId;
        }
        /// <summary>
