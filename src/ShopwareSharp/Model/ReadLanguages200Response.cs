...
namespace ShopwareSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "readLanguages_200_response")]
    public partial class ReadLanguages200Response : IEquatable<ReadLanguages200Response>, IValidatableObject
    {
        ...
        public ReadLanguages200Response(string apiAlias = default(string), string entity = default(string), int total = default(int), List<Object> aggregations = default(List<Object>), int page = default(int), int limit = default(int), List<Language> elements = default(List<Language>))
        {
        ...
        private List<Language> _Elements;
