...
{
    /// <summary>
    /// ReadLanguages200Response
    /// </summary>
    public partial class ReadLanguages200Response : IEquatable<ReadLanguages200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadLanguages200Response" /> class.
        /// </summary>
        /// <param name="entitySearchResult"></param>
        /// <param name="readLanguages200ResponseAllOf"></param>
        ...
        public ReadLanguages200Response(EntitySearchResult entitySearchResult, ReadLanguages200ResponseAllOf readLanguages200ResponseAllOf, string? apiAlias = default, string? entity = default, int? total = default, List<Object>? aggregations = default, int? page = default, int? limit = default)
        {
            EntitySearchResult = entitySearchResult;
            ReadLanguages200ResponseAllOf = readLanguages200ResponseAllOf;
            ApiAlias = apiAlias;
            Entity = entity;
            Total = total;
        ...
        /// <summary>
        /// Gets or Sets ReadLanguages200ResponseAllOf
        /// </summary>
        public ReadLanguages200ResponseAllOf ReadLanguages200ResponseAllOf { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadLanguages200Response {\n");
        ...
        {
            return this.Equals(input as ReadLanguages200Response);
        }

        /// <summary>
        /// Returns true if ReadLanguages200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadLanguages200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadLanguages200Response? input)
        {
            if (input == null)
            {
                return false;
    ...
    /// <summary>
    /// A Json converter for type ReadLanguages200Response
    /// </summary>
    public class ReadLanguages200ResponseJsonConverter : JsonConverter<ReadLanguages200Response>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadLanguages200Response).IsAssignableFrom(typeToConvert);
        ...
        public override ReadLanguages200Response Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader readLanguages200ResponseAllOfReader = reader;
            bool readLanguages200ResponseAllOfDeserialized = Client.ClientUtils.TryDeserialize<ReadLanguages200ResponseAllOf>(ref readLanguages200ResponseAllOfReader, options, out ReadLanguages200ResponseAllOf? readLanguages200ResponseAllOf);
            ...
            return new ReadLanguages200Response(entitySearchResult, readLanguages200ResponseAllOf, apiAlias, entity, total, aggregations, page, limit);
        }
        ...
        /// <param name="readLanguages200Response"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReadLanguages200Response readLanguages200Response, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
