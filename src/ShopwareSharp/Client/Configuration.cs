...
namespace ShopwareSharp.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://localhost/store-api";
        ...
        public Configuration(
            ...
            string basePath = "http://localhost/store-api") : this()
        {
        ...
        {
            string report = "C# SDK (ShopwareSharp) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 6.4.9999999.9999999-dev\n";
