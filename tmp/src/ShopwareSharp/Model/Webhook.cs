...
namespace ShopwareSharp.Model
{
    ...
    public partial class Webhook : IEquatable<Webhook>, IValidatableObject
    {
        ...
        public Webhook(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for Webhook and cannot be null.");
