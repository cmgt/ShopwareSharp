...
namespace ShopwareSharp.Model
{
    ...
    public partial class ProductPrice : IEquatable<ProductPrice>, IValidatableObject
    {
        ...
        public ProductPrice(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for ProductPrice and cannot be null.");
