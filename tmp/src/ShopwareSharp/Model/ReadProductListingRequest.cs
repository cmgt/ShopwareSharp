...
namespace ShopwareSharp.Model
{
    ...
    /// <summary>
    /// A Json converter for type ReadProductListingRequest
    /// </summary>
    public class ReadProductListingRequestJsonConverter : JsonConverter<ReadProductListingRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadProductListingRequest).IsAssignableFrom(typeToConvert);
        ...
        public override ReadProductListingRequest Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return new ReadProductListingRequest(productListingCriteria, productListingFlags, page, limit, filter, sort, postFilter, associations, aggregations, grouping, order, manufacturer, rating, properties, propertyWhitelist, reduceAggregations, p, minPrice, maxPrice, shippingFree, manufacturerFilter, priceFilter, ratingFilter, shippingFreeFilter, propertyFilter);
        }
        ...
        /// <param name="readProductListingRequest"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReadProductListingRequest readProductListingRequest, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
