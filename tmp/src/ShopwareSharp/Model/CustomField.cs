...
namespace ShopwareSharp.Model
{
    ...
    public partial class CustomField : IEquatable<CustomField>, IValidatableObject
    {
        ...
        public CustomField(DateTime createdAt, string? id = default, DateTime? updatedAt = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for CustomField and cannot be null.");
