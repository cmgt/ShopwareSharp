...
namespace ShopwareSharp.Model
{
    ...
    public partial class Plugin : IEquatable<Plugin>, IValidatableObject
    {
        ...
        public Plugin(DateTime createdAt, string? id = default, DateTime? updatedAt = default, Object? translated = default)
        {
            if (createdAt == null)
                throw new ArgumentNullException("createdAt is a required property for Plugin and cannot be null.");
