...
namespace ShopwareSharp.Model
{
    ...
    public partial class ReadProductReviews200Response : IEquatable<ReadProductReviews200Response>, IValidatableObject
    {
        ...
        /// <param name="readProductReviews200ResponseAllOf"></param>
        ...
        public ReadProductReviews200Response(EntitySearchResult entitySearchResult, ReadProductReviews200ResponseAllOf readProductReviews200ResponseAllOf, string? apiAlias = default, string? entity = default, int? total = default, List<Object>? aggregations = default, int? page = default, int? limit = default)
        {
            EntitySearchResult = entitySearchResult;
            ReadProductReviews200ResponseAllOf = readProductReviews200ResponseAllOf;
            ApiAlias = apiAlias;
            Entity = entity;
            Total = total;
        ...
        /// <summary>
        /// Gets or Sets ReadProductReviews200ResponseAllOf
        /// </summary>
        public ReadProductReviews200ResponseAllOf ReadProductReviews200ResponseAllOf { get; set; }
    ...
    /// <summary>
    /// A Json converter for type ReadProductReviews200Response
    /// </summary>
    public class ReadProductReviews200ResponseJsonConverter : JsonConverter<ReadProductReviews200Response>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override bool CanConvert(Type typeToConvert) => typeof(ReadProductReviews200Response).IsAssignableFrom(typeToConvert);
        ...
        public override ReadProductReviews200Response Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            Utf8JsonReader readProductReviews200ResponseAllOfReader = reader;
            bool readProductReviews200ResponseAllOfDeserialized = Client.ClientUtils.TryDeserialize<ReadProductReviews200ResponseAllOf>(ref readProductReviews200ResponseAllOfReader, options, out ReadProductReviews200ResponseAllOf? readProductReviews200ResponseAllOf);
            ...
            return new ReadProductReviews200Response(entitySearchResult, readProductReviews200ResponseAllOf, apiAlias, entity, total, aggregations, page, limit);
        }
        ...
        /// <param name="readProductReviews200Response"></param>
        /// <param name="options"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReadProductReviews200Response readProductReviews200Response, JsonSerializerOptions options) => throw new NotImplementedException();
    }
}
