...
namespace ShopwareSharp.Model
{
    ...
    public partial class ShippingMethodPageRouteResponseInnerSalesChannelDefaultAssignmentsInner : IEquatable<ShippingMethodPageRouteResponseInnerSalesChannelDefaultAssignmentsInner>, IValidatableObject
    {
        ...
        public ShippingMethodPageRouteResponseInnerSalesChannelDefaultAssignmentsInner(string? typeId = default, string? languageId = default, string? currencyId = default, string? paymentMethodId = default, string? shippingMethodId = default, string? countryId = default, string? navigationCategoryId = default, int? navigationCategoryDepth = default, string? footerCategoryId = default, string? serviceCategoryId = default, string? name = default, string? shortName = default, string? accessKey = default, bool? active = default, bool? maintenance = default, string? maintenanceIpWhitelist = default, string? mailHeaderFooterId = default, string? customerGroupId = default, bool? hreflangActive = default, string? hreflangDefaultDomainId = default)
        {
            TypeId = typeId;
        ...
        /// </summary>
        [JsonPropertyName("maintenanceIpWhitelist")]
